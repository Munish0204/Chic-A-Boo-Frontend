...
const Watches = () => {
  ...
  useEffect(() => {
    const fetchWatches = async () => {
      try {
        const res = await axios.get('https://chic-a-boo-backend.onrender.com/api/women/watches');
        setWatches(res.data);
      } catch (err) {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8">
      <h2 className="text-2xl font-bold mb-6 text-center">Women's Watches</h2>
        ...
        {watches.map((watch) => {
          ...
          return (
            <div
              ...
              onClick={() => navigate(`/women/watches/${watch._id}`)}
            >
              <button
              ...
              <button
                onClick={(e) => {
                  e.stopPropagation();
                  navigate(`/women/watches/${watch._id}`);
                }}
