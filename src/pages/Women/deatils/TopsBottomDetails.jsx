...
const usToIndian = (usSize) => {
  const map = { S: "38", M: "40", L: "42", XL: "44" };
  return map[usSize] || usSize;
};

const SIZES = ["S", "M", "L", "XL"];

const TopsBottomDetail = () => {
                ...
                return (
                  <button
                    ...
                    className={`px-4 py-2 rounded border transition 
                      ${selectedSize === indianSize ? "bg-black text-white border-black" : "bg-white text-black border-gray-300 hover:bg-gray-100"} 
...
export default TopsBottomDetail;
