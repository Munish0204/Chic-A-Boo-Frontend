...
const Shorts = () => {
  ...
  if (loading) return <p className="text-center mt-10">Loading shorts...</p>;
  if (error) return <p className="text-center mt-10 text-red-500">{error}</p>;

  return (
    <div className="max-w-7xl mx-auto px-4 py-8">
      <h2 className="text-2xl font-bold mb-6 text-center">Shorts</h2>
        ...
        {shorts.map((item) => {
          ...
          return (
            <div
              ...
              onClick={() => navigate(`/shorts/${item._id}`)}
            >
              <button
              ...
              <button
                onClick={(e) => {
                  e.stopPropagation();
                  if (!inCart) navigate(`/shorts/${item._id}`);
                }}
