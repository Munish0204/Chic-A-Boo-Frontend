  ...
  useEffect(() => {
    ...
    const fetchItem = async () => {
      try {
        ...
        console.error("Error fetching tracks item:", err);
    ...
    <div className="max-w-6xl mx-auto px-6 py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
        ...
        <div>
          ...
          {/* Tracks specific details */}
          <p className="mb-1">Length: {item.length || "Full-length"}</p>
          <p className="mb-1">Fit: {item.fit || "Slim"}</p>
